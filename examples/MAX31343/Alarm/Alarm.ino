...
void setup() {
  ...
  pinMode(MAX31343_INT_PIN, INPUT_PULLUP);
  Serial.begin(115200);
  ...
  attachInterrupt(digitalPinToInterrupt(MAX31343_INT_PIN), MAX31343_interrupt_handler, FALLING);
